...
class _HomeScreenState extends State<FirstGameScreen> {
  ...
  initGame() {
    ...
    items = [
      ...
      ItemModel(
          value: 'chicken', name: 'Chicken', img: 'assets/images/chicken.png'),
      ...
      ItemModel(
          value: 'giraffe', name: 'Giraffe', img: 'assets/images/giraffe.png'),
      ItemModel(value: 'goat', name: 'Goat', img: 'assets/images/goat.png'),
      ItemModel(value: 'horse', name: 'Horse', img: 'assets/images/horse.png'),
      ItemModel(
          value: 'panda_bear',
          name: 'Panda',
          img: 'assets/images/panda-bear.png'),
      ItemModel(
          value: 'penguin', name: 'Penguin', img: 'assets/images/penguin.png'),
